...
struc_mattergendft = load_generated_model(DATA_MODELS / "mattergen_dft.csv")


structure_list = [str_val, struc_mattergen, struc_mattergendft]

model_names = ["Validation", "MatterGen", "MatterGen-DFT"]
